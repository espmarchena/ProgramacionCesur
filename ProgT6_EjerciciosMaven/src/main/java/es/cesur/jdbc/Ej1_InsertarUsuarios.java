...
public class Ej1_InsertarUsuarios { // Insertar departamento con lo introducido por teclado, metiéndolo dentro de la instruccion sql y añadiendose a la bbdd
	...
	public static void main(String[] args) {
		...
		try {
			...
			String query = "INSERT INTO usuarios VALUES (null, '" + nombre + "', '" + clave + "')";
